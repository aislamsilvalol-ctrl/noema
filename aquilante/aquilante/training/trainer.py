...
from aquilante.features.sequences import Dataset


@dataclass
class TrainConfig:
    model: str = "aquilante"  # "dkt" | "aquilante"
...
def train(train_ds: Dataset, val_ds: Dataset, cfg: TrainConfig, *, log=print) -> TrainResult:
    ...
    from aquilante.models.neural import NeuralModel, bce_masked, set_seed  # noqa: PLC0415
...
def load_checkpoint(path: Path, device: str | None = None):
    ...
    from aquilante.models.neural import NeuralModel  # noqa: PLC0415
