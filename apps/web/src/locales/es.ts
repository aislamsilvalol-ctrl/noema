...
export const es: Dict = {
  ...
  errorBoundary: {
    ...
    body: 'Lo que ya enviaste está guardado. Inténtalo de nuevo. Si sigue pasando, recarga la página.',
  ...
  notFound: {
    title: 'Este trozo del mapa está en blanco.',
    body: 'La dirección no lleva a ningún lugar que NOEMA conozca. El resto de tu territorio sigue donde lo dejaste.',
    backHome: 'Volver al inicio',
  ...
  progression: {
    sessionTitle: 'Lo que sumó esta sesión',
    missionsDone: (done: number, total: number) => `${done} de ${total} misiones hechas hoy`,
  ...
  notebook: {
    ...
    noNotesTitle: 'Ninguna nota todavía.',
    noNotes:
      'Las notas existen para volverse preguntas — escribe lo que intentas entender, no lo que ya sabes.',
  },
  ...
  cards: {
    ...
    nothingWaitingBody: 'Redacta tarjetas a partir de tu material, o escribe una arriba.',
    approve: 'Aprobar',
    discard: 'Descartar',
    ...
    noCardsBody: 'Las tarjetas que apruebas o escribes aparecen aquí.',
    newCard: 'nueva',
  ...
  socratic: {
    ...
    emptyTitle: 'Nada que cuestionar todavía.',
    emptyBody: 'Los conceptos vienen de lo que aprendes con Mino y del material de tus cuadernos.',
    emptyAction: 'Empezar a aprender',
  ...
  chat: {
    feedbackQuestion: '¿Te ayudó?',
    feedbackYes: 'Me ayudó',
    feedbackNo: 'No me ayudó',
    feedbackThanks: 'Gracias. Mino lo tiene en cuenta.',
    summaryTitle: 'La clase de hoy',
    summaryShaky: 'Todavía frágil',
    summaryKeepGoing: 'Seguir con la clase',
    summaryHome: 'Volver a Hoy',
    you: 'Tú',
    title: 'Mino',
    ...
    continueTitle: 'Seguir donde lo dejaste',
    lessonMissing: 'Esa clase ya no está abierta. Elige otra o empieza algo nuevo.',
  ...
  professor: {
    ...
    composer: {
      moreActions: 'Más',
      actionsTitle: '¿Qué debe hacer Mino?',
      speak: 'Hablar',
