...
export const pt: Dict = {
  ...
  landing3: {
    ...
    rememberNext: (days: number) => `Próxima revisão em ${days} dias`,
    closeTitle: 'Aprenda qualquer coisa.',
    closeBody: 'Grátis para começar. Seu material continua seu.',
    start: 'Começar',
    continueLearning: 'Continuar aprendendo',
    signIn: 'Entrar',
  ...
  landing: {
    ...
    demoSteps: (subject: string) => [
      `Por onde ${subject || 'isso'} começa: a pergunta que tenta responder, e por que importa`,
      'A primeira ideia central, explicada com um exemplo antes do termo',
      'Uma checagem rápida — uma pergunta que mostra se ficou claro',
      'A ideia seguinte, só depois que a primeira se sustenta',
      'Revisões marcadas para o momento em que você está prestes a esquecer',
    ],
    demoNote:
      'Uma ilustração, não um resultado gerado. O caminho de verdade é construído para você, a partir do que já sabe, na hora em que começar.',
    demoStart: (subject: string) => `Começar a aprender ${subject}`,
    signIn: 'Entrar',
    ...
    beatsLabel: 'Como funciona',
    samples: {
      learner: 'O que é o inconsciente para Freud?',
      lesson:
        'Comece pelo lapso: chamar a namorada nova pelo nome da ex. Para Freud isso não é acaso — é o **inconsciente** vazando um conflito que a pessoa não admite. Agora: se um amigo "esqueceu" um aniversário de propósito, sem querer, que parte da mente fez o trabalho?',
      concepts: [
        ['Regra da cadeia', 38],
        ['Backpropagation', 46],
      ...
      confident: 'Certeza',
      verdict: 'Não é bem isso — e você tinha certeza.',
      misconception: 'Concepção errada registrada',
      source: 'Kandel, Princípios de Neurociência · p. 412',
      excerpt: '"…o potencial de ação é tudo-ou-nada: a amplitude não varia com o estímulo."',
      notFound: 'Não está no seu material — eu digo isso em vez de inventar.',
      options: ['Sístole', 'Diástole', 'Contração isovolumétrica'],
      generated: 'Escrita a partir das suas notas sobre o ciclo cardíaco',
      due: 'Diástole',
      next: 'Próxima revisão em 11 dias — logo antes de você esquecer.',
    },
    pricingTitle: 'Planos',
