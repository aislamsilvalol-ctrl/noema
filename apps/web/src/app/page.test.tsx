...
describe('LandingPage', () => {
  ...
  it('shows the engine as eight steps, and a wrong answer moves what it knows and what it will do', async () => {
    ...
    const user = userEvent.setup();
    render(<LandingPage />);
    for (const id of ['step-1', 'step-2', 'step-3', 'step-4', 'step-5', 'step-6', 'step-7', 'step-8']) {
    ...
    expect(screen.getByText(/Next time it will not define/)).toBeInTheDocument();
  });
  ...
  it('says plainly how it differs from a chatbot, and keeps the legal links real', () => {
    ...
    expect(screen.getByText('Noema asks what you do not know yet.')).toBeInTheDocument();
