...
export default function ExamPage() {
  ...
  // Reaching an exam this way -- generated by Professor Noema from a chat
  // (`/notebooks/[id]/professor`) rather than started with the button below
  // -- means the paper already exists; load it instead of offering to start
  // a second, orphaned one over the same questions.
  useEffect(() => {
    ...
    // changing (e.g. after this effect sets `exam`) must not re-trigger it.
